...
import { EducationEntry } from "@/machines/types";
import BulletPoints from "@/components/Control/common/BulletPoints";

import { FormState, FormReducerEvent, EducationExtra } from "./types";
    ...
    return (
        <div className="flex flex-col min-h-full pb-20">
            ...
            <div className="flex flex-col">
                <TextInput placeholder="Degree" value={state.degree}
                    onChange={e => dispatch({
                        type: 'field.change',
                        field: 'degree',
                ...
                />
                <TextInput placeholder="University/Institution" value={state.university}
                    onChange={e => dispatch({
                        type: 'field.change',
                        field: 'university',
                        value: e.target.value
                    })} />
                <TextInput placeholder="Location" value={state.location}
                    onChange={e => dispatch({
                        type: 'field.change',
                        field: 'location',
                        value: e.target.value
                ...
                <div className="flex gap-2">
                    <TextInput className="w-0 flex-grow" placeholder="Start Date"
                    ...
                    <TextInput className="w-0 flex-grow" placeholder="End Date"
                        value={state.endDate}
                        onChange={e => dispatch({
                            type: 'field.change',
                            field: 'endDate',
