...
export default function Panel() {
    ...
    function createTemplate() {
        emit({ type: 'createTemplate' })
    }

    const menuItemMobileClassName = "mb-7 lg:mb-0 lg:ml-7 max-sm:opacity-0 max-sm:h-0 max-sm:mb-0 peer-checked:opacity-100 peer-checked:h-16 peer-checked:mb-7 transition-menu-item-show"

    return (
        <div className="fixed bottom-4 left-4 sm:left-6 lg:bottom-8 lg:left-8 flex flex-col-reverse lg:flex-row gap-07 items-start lg:items-end print:hidden z-30">
            <ControlCenter />

            <input id="expandMenu" type='checkbox' className='hidden peer' onChange={importJson} />
            {/* export */}
            <Button onClick={exportJson} text='export your data' className={menuItemMobileClassName}>
            ...
            {/* import */}
            <label className={twMerge("group relative h-16 w-16 mb-7 fill-[#eee] stroke-none stroke-2 flex cursor-pointer", menuItemMobileClassName)} >
            ...
            {/* print */}
            <Button onClick={printDoc} text="print resume" className={menuItemMobileClassName}>
                <svg viewBox="0 0 20 20" className='h-full w-full'>
            ...
            {/* create template */}
            <Button onClick={createTemplate} text="create template" className={menuItemMobileClassName} >
            ...
            <label htmlFor="expandMenu" className="group relative h-16 w-16 max-sm:p-2 max-sm:mb-3  fill-[#eee] stroke-none stroke-2 flex sm:hidden cursor-pointer mb-7 peer-checked:[&_path:first-of-type]:hidden peer-checked:[&_path:last-of-type]:block">
                <div className='relative h-full w-full p-3 lg:p-5 z-10 bg-yellow-700 rounded-full shadow'>
                    <svg className="hidden w-full h-full stroke-white transition-all duration-300 delay-100" viewBox="0 0 20 20" fill="none">
                        <path d="M 10 17 l -0 -12.7279 m 0 0 l -6.364 6.364 m 6.364 -6.364 l 6.364 6.364" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                    <svg className="w-full h-full stroke-white fill-white transition-all duration-300 delay-100" viewBox="0 0 24 24" fill="none">
                        <path d="M 13.499 11.997 c 0 0.8285 -0.6715 1.5 -1.5 1.5 c -0.8285 0 -1.5 -0.6715 -1.5 -1.5 c 0 -0.8285 0.6715 -1.5 1.5 -1.5 c 0.8285 0 1.5 0.6715 1.503 1.497 z M 13.501 21.486 c 0 0.8284 -0.6715 1.5 -1.5 1.5 c -0.8285 0 -1.5 -0.6716 -1.5 -1.5 c 0 -0.8284 0.6715 -1.5 1.5 -1.5 c 0.8285 0 1.5 0.6716 1.5 1.496 z M 13.5 2.505 c 0 0.8284 -0.6715 1.5 -1.5 1.5 c -0.8285 0 -1.5 -0.6716 -1.5 -1.5 c 0 -0.8284 0.6715 -1.5 1.5 -1.5 c 0.8285 0 1.5 0.6716 1.5 1.5 z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path className='hidden' d="M6 6L18 18M18 6L6 18" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                </div>
            </label>
        </div>
